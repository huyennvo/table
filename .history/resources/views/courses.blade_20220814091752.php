...
@section('content-body')
 ...
 <!-- Modal body -->
        ...
        <div class="modal-body">
          ...
          <input type="text" id="course-id" name="course-id" style="width:80%"><br>
          <label for="teacher" style="width:18%">Giảng viên: </label>
          <input type="text" id="teacher" name="teacher" style="width:80%"><br>
          <label for="description" style="width:18%">Mô tả: </label>
          <textarea name = "description" class="ckeditor" style="width:80%"></textarea><br>
          <label for="title">Title : </label>
  <textarea rows="5" id="title" name="title" class="ckeditor"></textarea>
          <label for="quiz" style="width:18%">Câu hỏi:</label>
          <input type="text" id="quiz" name="quiz" style="width:80%"><br>
          <label for="document" style="width:18%">Tài liệu:</label>
          <input type="text" id="document" name="document" style="width:80%"><br>
          <label for="homework" style="width:18%">Bài tập: </label>
          <input type="text" id="homework" name="homework" style="width:80%"><br>
