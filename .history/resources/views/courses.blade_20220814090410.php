...
@section('content-body')
 ...
 <!-- Modal body -->
        ...
        <div class="modal-body">
          <label for="name" style="width:120px">Tên bài giảng: </label>
          <input type="text" id="name" name="name"><br>
          <label for="course-id" style="width:120px">Khóa học: </label>
          <input type="text" id="course-id" name="course-id"><br>
          <label for="teacher" style="width:120px">Giảng viên: </label>
          <input type="text" id="teacher" name="teacher"><br>
          <label for="description" style="width:120px">Mô tả: </label>
          <textarea name = "description" class="ckeditor"> Text </textarea><br>
          <label for="quiz" style="width:120px">Câu hỏi:</label>
          <input type="text" id="quiz" name="quiz"><br>
          <label for="document" style="width:120px">Tài liệu:</label>
          <input type="text" id="document" name="document"><br>
          <label for="homework" style="width:120px">Bài tập: </label>
